...
# Set Date 
DATE=$(TZ=Asia/Jakarta date +"%H%M%S")
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone()
 {
	...
	then
		...
		git clone --no-tags --single-branch --depth 1 https://github.com/kdrag0n/proton-clang.git clang-llvm
		# Toolchain Directory defaults to clang-llvm
		TC_DIR=$KERNEL_DIR/clang-llvm
	fi

	msger -n "|| Cloning Anykernel3 ||"
	git clone --depth 1 https://github.com/leon4rd/AnyKernel3.git -b onclite
